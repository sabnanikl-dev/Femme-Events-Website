...
export default function About() {
  return (
    <section id="about" className="py-24 px-6 md:px-24 bg-femme-lavender grid md:grid-cols-2 gap-16 items-center">
      <motion.div
      ...
      >
        <h2 className="text-6xl md:text-7xl text-femme-dark leading-tight italic">
